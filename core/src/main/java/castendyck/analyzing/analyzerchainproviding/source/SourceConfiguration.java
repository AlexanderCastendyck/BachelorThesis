...
public class SourceConfiguration {
    ...
    public SourceConfiguration(PomFile pomFile, DependencyGraph dependencyGraph, LocalRepository localRepository, Path projectRootPath, MavenTestPathIdentifier generalMavenTestPathPart) {
